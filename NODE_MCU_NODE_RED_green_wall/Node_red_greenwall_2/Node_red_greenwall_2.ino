...
// lamp1 - LED - GPIO 4 = D2 on ESP-12E NodeMCU board       // D4 podouje problem przy restarcie zasilania
const int lamp1 = D5;
const int zawor = D3;
const int lamp2 = D6;
...
void callback(String topic, byte* message, unsigned int length) {
 ...
 // If a message is received on the topic kuchnia/lamp2, you check if the message is either on or off. Turns the lamp GPIO according to the message
  if(topic=="kuchnia/lamp2"){
    ...
    */
    if (client.connect("esp_greenwall")){
      ...
      client.subscribe("kuchnia/podlewanie");
        ...
        client.subscribe("kuchnia/lamp2");
        client.subscribe("kuchnia/cyrkulacja");
    } else {
